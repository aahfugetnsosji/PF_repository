...
(function($) {
    ...
    var conf = {
        prefectures: [
            { code: 1, name: "北海道", full: "", alphabet: "Hokkaido", area8: 1, area11: 1, cordinate: { x: 41, y: 1, z: 29 }, size: { x: 14, y: 4 }, radius: [1, 1, 1, 0], box : { cordinate: { x: 32, y: 2 }, size : { x: 12, y: 3}}, number: 29 },
            { code: 2, name: "青森", full: "県", alphabet: "Aomori", area8: 1, area11: 2, cordinate: { x: 41, y: 5, z: 30 }, size: { x: 12, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 3, name: "岩手", full: "県", alphabet: "Iwate", area8: 1, area11: 2, cordinate: { x: 47, y: 7, z: 33 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 4, name: "宮城", full: "県", alphabet: "Miyagi", area8: 1, area11: 2, cordinate: { x: 47, y: 9, z: 34 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 5, name: "秋田", full: "県", alphabet: "Akita", area8: 1, area11: 2, cordinate: { x: 41, y: 7, z: 31 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], box : { cordinate: { x: 30, y: 6 }, size : { x: 12, y: 3}}, number: 29 },
            { code: 6, name: "山形", full: "県", alphabet: "Yamagata", area8: 1, area11: 2, cordinate: { x: 41, y: 9, z: 32 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 7, name: "福島", full: "県", alphabet: "Fukushima", area8: 1, area11: 2, cordinate: { x: 45, y: 11, z: 39 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 8, name: "茨城", full: "県", alphabet: "Ibaraki", area8: 2, area11: 3, cordinate: { x: 49, y: 13, z: 42 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 9, name: "栃木", full: "県", alphabet: "Tochigi", area8: 2, area11: 3, cordinate: { x: 45, y: 13, z: 41 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 10, name: "群馬", full: "県", alphabet: "Gunma", area8: 2, area11: 3, cordinate: { x: 41, y: 13, z: 40 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 11, name: "埼玉", full: "県", alphabet: "Saitama", area8: 2, area11: 3, cordinate: { x: 41, y: 16, z: 43 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 12, name: "千葉", full: "県", alphabet: "Chiba", area8: 2, area11: 3, cordinate: { x: 49, y: 16, z: 46 }, size: { x: 4, y: 5 }, radius: [0, 0, 1, 0], number: 29 },
            { code: 13, name: "東京", full: "都", alphabet: "Tokyo", area8: 2, area11: 3, cordinate: { x: 41, y: 18, z: 44 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 14, name: "神奈川", full: "県", alphabet: "Kanagawa", area8: 2, area11: 3, cordinate: { x: 41, y: 20, z: 45 }, size: { x: 8, y: 2 }, radius: [0, 0, 1, 0], number: 29 },
            { code: 15, name: "新潟", full: "県", alphabet: "Niigata", area8: 3, area11: 4, cordinate: { x: 37, y: 11, z: 35 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 16, name: "富山", full: "県", alphabet: "Toyama", area8: 3, area11: 4, cordinate: { x: 33, y: 11, z: 26 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 17, name: "石川", full: "県", alphabet: "Ishikawa", area8: 3, area11: 4, cordinate: { x: 29, y: 10, z: 18 }, size: { x: 4, y: 2 }, radius: [1, 1, 0, 0], number: 29 },
            { code: 18, name: "福井", full: "県", alphabet: "Fukui", area8: 3, area11: 4, cordinate: { x: 27, y: 12, z: 19 }, size: { x: 6, y: 2 }, radius: [1, 0, 0, 0], number: 29 },
            { code: 19, name: "山梨", full: "県", alphabet: "Yamanashi", area8: 3, area11: 3, cordinate: { x: 37, y: 17, z: 37 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 20, name: "長野", full: "県", alphabet: "Nagano", area8: 3, area11: 3, cordinate: { x: 37, y: 13, z: 36 }, size: { x: 4, y: 4 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 21, name: "岐阜", full: "県", alphabet: "Gifu", area8: 4, area11: 5, cordinate: { x: 33, y: 13, z: 27 }, size: { x: 4, y: 4 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 22, name: "静岡", full: "県", alphabet: "Shizuoka", area8: 4, area11: 5, cordinate: { x: 37, y: 19, z: 38 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 1], number: 29 },
            { code: 23, name: "愛知", full: "県", alphabet: "Aichi", area8: 4, area11: 5, cordinate: { x: 33, y: 17, z: 28 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 24, name: "三重", full: "県", alphabet: "Mie", area8: 4, area11: 5, cordinate: { x: 29, y: 18, z: 24 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 25, name: "滋賀", full: "県", alphabet: "Shiga", area8: 5, area11: 6, cordinate: { x: 29, y: 14, z: 22 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 26, name: "京都", full: "府", alphabet: "Kyoto", area8: 5, area11: 6, cordinate: { x: 25, y: 14, z: 20 }, size: { x: 4, y: 3 }, radius: [1, 0, 0, 0], number: 29 },
            { code: 27, name: "大阪", full: "府", alphabet: "Osaka", area8: 5, area11: 6, cordinate: { x: 25, y: 17, z: 21 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 28, name: "兵庫", full: "県", alphabet: "Hyogo", area8: 5, area11: 6, cordinate: { x: 21, y: 15, z: 13 }, size: { x: 4, y: 4 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 29, name: "奈良", full: "県", alphabet: "Nara", area8: 5, area11: 6, cordinate: { x: 29, y: 16, z: 23 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 30, name: "和歌山", full: "県", alphabet: "Wakayama", area8: 5, area11: 6, cordinate: { x: 25, y: 20, z: 25 }, size: { x: 6, y: 2 }, radius: [0, 0, 1, 1], number: 29 },
            { code: 31, name: "鳥取", full: "県", alphabet: "Tottori", area8: 6, area11: 7, cordinate: { x: 17, y: 15, z: 11 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 32, name: "島根", full: "県", alphabet: "Shimane", area8: 6, area11: 7, cordinate: { x: 13, y: 15, z: 9 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 33, name: "岡山", full: "県", alphabet: "Okayama", area8: 6, area11: 7, cordinate: { x: 17, y: 17, z: 12 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 34, name: "広島", full: "県", alphabet: "Hiroshima", area8: 6, area11: 7, cordinate: { x: 13, y: 17, z: 10 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 35, name: "山口", full: "県", alphabet: "Yamaguchi", area8: 6, area11: 9, cordinate: { x: 9, y: 15, z: 8 }, size: { x: 4, y: 4 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 36, name: "徳島", full: "県", alphabet: "Tokushima", area8: 7, area11: 8, cordinate: { x: 17, y: 21, z: 17 }, size: { x: 6, y: 2 }, radius: [0, 0, 1, 0], number: 29 },
            { code: 37, name: "香川", full: "県", alphabet: "Kagawa", area8: 7, area11: 8, cordinate: { x: 17, y: 19, z: 16 }, size: { x: 6, y: 2 }, radius: [0, 1, 0, 0], number: 29 },
            { code: 38, name: "愛媛", full: "県", alphabet: "Ehime", area8: 7, area11: 8, cordinate: { x: 11, y: 19, z: 14 }, size: { x: 6, y: 2 }, radius: [1, 0, 0, 0], number: 29 },
            { code: 39, name: "高知", full: "県", alphabet: "Kochi", area8: 7, area11: 8, cordinate: { x: 11, y: 21, z: 15 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 1], number: 29 },
            { code: 40, name: "福岡", full: "県", alphabet: "Fukuoka", area8: 8, area11: 9, cordinate: { x: 5, y: 15, z: 4 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 41, name: "佐賀", full: "県", alphabet: "Saga", area8: 8, area11: 9, cordinate: { x: 1, y: 17, z: 2 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 42, name: "長崎", full: "県", alphabet: "Nagasaki", area8: 8, area11: 9, cordinate: { x: 1, y: 15, z: 1 }, size: { x: 4, y: 2 }, radius: [1, 0, 0, 0], number: 29 },
            { code: 43, name: "熊本", full: "県", alphabet: "Kumamoto", area8: 8, area11: 9, cordinate: { x: 1, y: 19, z: 3 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 44, name: "大分", full: "県", alphabet: "Oita", area8: 8, area11: 9, cordinate: { x: 5, y: 17, z: 5 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 45, name: "宮崎", full: "県", alphabet: "Miyazaki", area8: 8, area11: 10, cordinate: { x: 5, y: 19, z: 6 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
            { code: 46, name: "鹿児島", full: "県", alphabet: "Kagoshima", area8: 8, area11: 10, cordinate: { x: 1, y: 21, z: 7 }, size: { x: 8, y: 2 }, radius: [0, 0, 1, 1], number: 29 },
            { code: 47, name: "沖縄", full: "県", alphabet: "Okinawa", area8: 8, area11: 11, cordinate: { x: 18, y: 11, z: 47 }, size: { x: 4, y: 2, z: 47 }, radius: [1, 1, 1, 1], number: 29 }
        ],
    ...
    $.fn.jmap = function(options) {
        ...
        var params = $.extend({
            ...
            prefectureBackgroundColor: '#0f0001',
            prefectureBackgroundHoverColor: '#990000',
            prefectureLineY: '0px',
            prefectureLineX: '0px',
            prefectureLineWidth: '1px',
            prefectureLineGap: '1px',
            prefectureLineColor: 'transparent',
            prefectureLineHoverColor: 'transparent',
            ...
            showHeatlabel: true,
            heatmapType: 'Greys',
            heatmapColors: ["#919191", "#7D7D7D", "#696969", "#545454", "#2E2E2E", "#0f0001"],
            heatmapLabelUnit: '件',
            heatmapFontColors: [],
            heatmapConditions: ["<10", ">=10", ">=30", ">=50", ">=70", ">=100" ],
            viewType: 'map',
            gridNumber: 6,
            gridOffset: 1,
            gridTotalRows: 22,
            ...
            areas: [
                { code: 1, name: "北海道", number: 29 },
                { code: 2, name: "青森", number: 29 },
                { code: 3, name: "岩手", number: 29 },
                { code: 4, name: "宮城", number: 29 },
                { code: 5, name: "秋田", number: 29 },
                { code: 6, name: "山形", full: "県", alphabet: "Yamagata", area8: 1, area11: 2, cordinate: { x: 41, y: 9, z: 32 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
                { code: 7, name: "福島", full: "県", alphabet: "Fukushima", area8: 1, area11: 2, cordinate: { x: 45, y: 11, z: 39 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0], number: 29 },
                { code: 8, name: "茨城", full: "県", alphabet: "Ibaraki", area8: 2, area11: 3, cordinate: { x: 49, y: 13, z: 42 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
                { code: 9, name: "栃木", full: "県", alphabet: "Tochigi", area8: 2, area11: 3, cordinate: { x: 45, y: 13, z: 41 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0], number: 29 },
