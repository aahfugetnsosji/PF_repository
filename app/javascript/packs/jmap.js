...
(function($) {
    ...
    var conf = {
        prefectures: [
            ...
            { code: 2, name: "青森", full: "県", alphabet: "Aomori", area8: 1, area11: 2, cordinate: { x: 41, y: 5, z: 30 }, size: { x: 12, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 3, name: "岩手", full: "県", alphabet: "Iwate", area8: 1, area11: 2, cordinate: { x: 47, y: 7, z: 33 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 4, name: "宮城", full: "県", alphabet: "Miyagi", area8: 1, area11: 2, cordinate: { x: 47, y: 9, z: 34 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 5, name: "秋田", full: "県", alphabet: "Akita", area8: 1, area11: 2, cordinate: { x: 41, y: 7, z: 31 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0], box : { cordinate: { x: 30, y: 6 }, size : { x: 12, y: 3}} },
            { code: 6, name: "山形", full: "県", alphabet: "Yamagata", area8: 1, area11: 2, cordinate: { x: 41, y: 9, z: 32 }, size: { x: 6, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 7, name: "福島", full: "県", alphabet: "Fukushima", area8: 1, area11: 2, cordinate: { x: 45, y: 11, z: 39 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 8, name: "茨城", full: "県", alphabet: "Ibaraki", area8: 2, area11: 3, cordinate: { x: 49, y: 13, z: 42 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0] },
            { code: 9, name: "栃木", full: "県", alphabet: "Tochigi", area8: 2, area11: 3, cordinate: { x: 45, y: 13, z: 41 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0] },
            { code: 10, name: "群馬", full: "県", alphabet: "Gunma", area8: 2, area11: 3, cordinate: { x: 41, y: 13, z: 40 }, size: { x: 4, y: 3 }, radius: [0, 0, 0, 0] },
            { code: 11, name: "埼玉", full: "県", alphabet: "Saitama", area8: 2, area11: 3, cordinate: { x: 41, y: 16, z: 43 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 12, name: "千葉", full: "県", alphabet: "Chiba", area8: 2, area11: 3, cordinate: { x: 49, y: 16, z: 46 }, size: { x: 4, y: 5 }, radius: [0, 0, 1, 0] },
            { code: 13, name: "東京", full: "都", alphabet: "Tokyo", area8: 2, area11: 3, cordinate: { x: 41, y: 18, z: 44 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 14, name: "神奈川", full: "県", alphabet: "Kanagawa", area8: 2, area11: 3, cordinate: { x: 41, y: 20, z: 45 }, size: { x: 8, y: 2 }, radius: [0, 0, 1, 0] },
            { code: 15, name: "新潟", full: "県", alphabet: "Niigata", area8: 3, area11: 4, cordinate: { x: 37, y: 11, z: 35 }, size: { x: 8, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 16, name: "富山", full: "県", alphabet: "Toyama", area8: 3, area11: 4, cordinate: { x: 33, y: 11, z: 26 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 17, name: "石川", full: "県", alphabet: "Ishikawa", area8: 3, area11: 4, cordinate: { x: 29, y: 10, z: 18 }, size: { x: 4, y: 2 }, radius: [1, 1, 0, 0] },
            { code: 18, name: "福井", full: "県", alphabet: "Fukui", area8: 3, area11: 4, cordinate: { x: 27, y: 12, z: 19 }, size: { x: 6, y: 2 }, radius: [1, 0, 0, 0] },
            { code: 19, name: "山梨", full: "県", alphabet: "Yamanashi", area8: 3, area11: 3, cordinate: { x: 37, y: 17, z: 37 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0] },
            { code: 20, name: "長野", full: "県", alphabet: "Nagano", area8: 3, area11: 3, cordinate: { x: 37, y: 13, z: 36 }, size: { x: 4, y: 4 }, radius: [0, 0, 0, 0] },
            ...
            { code: 24, name: "三重", full: "県", alphabet: "Mie", area8: 4, area11: 5, cordinate: { x: 29, y: 18, z: 24 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 0] },
    ...
    $.fn.jmap = function(options) {
        ...
        var params = $.extend({
            ...
            prefectureBackgroundColor: '#161616',
